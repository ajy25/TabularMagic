...
class _TestEqualMeans_ToolArgs(BaseModel):
    ...
    numerical_var : str = Field(
        description="The numerical variable of interest."
    )
    stratify_by : str = Field(
        description="The grouping variable."
    )
...
def test_equal_means_tool(numerical_var: str, stratify_by: str) -> str:
    ...
    """
    return shared_analyzer.get_shared_analyzer().eda().test_equal_means(
