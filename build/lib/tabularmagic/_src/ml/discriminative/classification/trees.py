...
class TreeC(BaseClassification):
...
class TreeEnsembleC(BaseClassification):
    ...
    def __init__(self, 
        ...
        if type == 'random_forest':
            ...
            self._estimator = AdaBoostClassifier(
                random_state=model_random_state)
            if (hyperparam_search_method is None) or \
                (hyperparam_grid_specification is None):
                hyperparam_search_method = 'grid'
            ...
            self._estimator = BaggingClassifier(
                random_state=model_random_state)
            if (hyperparam_search_method is None) or \
                (hyperparam_grid_specification is None):
                hyperparam_search_method = 'grid'
            ...
            self._estimator = xgb.XGBRFClassifier(
                random_state=model_random_state)
            if (hyperparam_search_method is None) or \
                (hyperparam_grid_specification is None):
                hyperparam_search_method = 'grid'
